                ...
                <CommandList>
                    ...
                    <CommandGroup heading='Sub Accounts'>
                        {!!user.Agency?.SubAccount.length ? user.Agency.SubAccount.map((subaccount: SubAccount) => (
                            <CommandItem key={subaccount.id} className='className="h-32 !bg-background my-2 text-primary border-[1px] border-border p-4 rounded-lg hover:!bg-background cursor-pointer transition-all"'>
                              ...
                              <AlertDialogContent>
                                ...
                                <AlertDescription className='text-left'>
                                    This action cannot be undone . this will delete the sub account and all details related to sub account.
                                </AlertDescription>
                               </AlertDialogHeader>
