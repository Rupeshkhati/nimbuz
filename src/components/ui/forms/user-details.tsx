...
import { changeUserPermissions, getAuthUserDetails, getUserPermissions, saveActivityLogsNotification, updateUser } from '@/lib/queires'
      ...
      <CardContent>
        <Form {...form}>
          ...
          <FormField
            ...
            <Select disabled={form.formState.isSubmitting}
            onValueChange={(value) => {
              if (
